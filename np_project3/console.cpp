...
class tcp_client {
public:
  tcp_client() : _socket(global_io_service), _resolver(global_io_service) {}
  ...
  void do_connect(server_info &_server, tcp::resolver::iterator &it) {
    ...
    _socket.async_connect(_endpoint,
                          [this, &_server](boost::system::error_code ec) {
                            if (!ec) {
                              // connect success.
                              do_read(_server);
                            } else {
...
int main(void) {
  // setenv ("QUERY_STRING",
  // "h0=nplinux4.cs.nctu.edu.tw&p0=10000&f0=t1.txt&h1=nplinux4.cs.nctu.edu.tw&p1=10000&f1=t2.txt&h2=nplinux4.cs.nctu.edu.tw&p2=10000&f2=t3.txt&h3=nplinux4.cs.nctu.edu.tw&p3=10000&f3=t4.txt&h4=nplinux4.cs.nctu.edu.tw&p4=10000&f4=t5.txt",
