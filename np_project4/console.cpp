...
int main (void)
{
    //setenv ("QUERY_STRING", "h0=nplinux1.cs.nctu.edu.tw&p0=9999&f0=t1.txt&h1=nplinux1.cs.nctu.edu.tw&p1=9999&f1=t2.txt&h2=nplinux1.cs.nctu.edu.tw&p2=9999&f2=t3.txt&h3=nplinux1.cs.nctu.edu.tw&p3=9999&f3=t4.txt&h4=nplinux1.cs.nctu.edu.tw&p4=9999&f4=t5.txt&sh=nplinux5.cs.nctu.edu.tw&sp=4567", 1);
    // setenv ("QUERY_STRING", "h0=nplinux1.cs.nctu.edu.tw&p0=9999&f0=t1.txt&h1=nplinux1.cs.nctu.edu.tw&p1=9999&f1=t2.txt&h2=nplinux1.cs.nctu.edu.tw&p2=9999&f2=t3.txt&h3=nplinux1.cs.nctu.edu.tw&p3=9999&f3=t4.txt&h4=nplinux1.cs.nctu.edu.tw&p4=9999&f4=t5.txt&sh=nplinux5.cs.nctu.edu.tw&sp=4567", 1);
    // setenv ("QUERY_STRING", "h0=nplinux4.cs.nctu.edu.tw&p0=10000&f0=t1.txt&h1=&p1=&f1=&h2=&p2=&f2=&h3=&p3=&f3=&h4=&p4=&f4=", 1);
    // setenv ("QUERY_STRING", "h0=nplinux1.cs.nctu.edu.tw&p0=10000&f0=t1.txt&h1=nplinux1.cs.nctu.edu.tw&p1=10000&f1=t2.txt&h2=&p2=&f2=&h3=&p3=&f3=&h4=&p4=&f4=", 1);
    // setenv ("QUERY_STRING", "h0=nplinux4.cs.nctu.edu.tw&p0=10000&f0=t1.txt&h1=&p1=&f1=&h2=&p2=&f2=&h3=&p3=&f3=&h4=nplinux4.cs.nctu.edu.tw&p4=10000&f4=t5.txt", 1);
    // setenv ("QUERY_STRING", "h0=nplinux1.cs.nctu.edu.tw&p0=9999&f0=t1.txt&h1=nplinux1.cs.nctu.edu.tw&p1=9999&f1=t2.txt&h2=nplinux1.cs.nctu.edu.tw&p2=9999&f2=t3.txt&h3=&p3=&f3=&h4=&p4=&f4=&sh=nplinux5.cs.nctu.edu.tw&sp=4567", 1);
...
static void parse_query (char *query)
{
    ...
    for (int i = 1; i <= SERVER_SIZE; ++i)
    {
        if (i == SERVER_SIZE)
        {
            ...
            n = sscanf (query, "h%*[0-9]=%[a-zA-Z0-9.]&p%*[0-9]=%[0-9]&f%*[0-9]=%[a-zA-Z0-9.]&sh=%[a-zA-Z0-9.]&sp=%[0-9]&", server[i].domain_name, server[i].port, server[i].filename, socks.host, socks.port);
            socks.enable = 1;
        }
        else
        {
        ...
        else if (strlen(server[i].domain_name) != 0 && strlen(server[i].port) != 0 && strlen(server[i].filename) != 0)
        {
            connect_number++;
            server[i].enable = 1;
        }
...
static void print_html_web()
{
    ...
    for (int i = 1; i <= SERVER_SIZE; ++i)
    {
        if (server[i].enable)
        {
            printf("<th scope=\"col\">%s:%s</th><br>", server[i].domain_name, server[i].port);
        }
    }
